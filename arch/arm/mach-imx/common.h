...
static inline unsigned int imx_gpc_is_m4_sleeping(void) {
        return 0;
}
#endif
...
#else
static inline int imx_gpcv2_mf_power_on(unsigned int irq, unsigned int on) {
        return 0;
}
...
#else
static inline int imx_mmdc_get_ddr_type(void) {
        return 0;
}
#endif
...
#else
static inline int imx_ddrc_get_ddr_type(void) {
        return 0;
}
#endif
